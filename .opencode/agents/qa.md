---
description: Meticulous QA subagent for test planning, bug hunting, edge-case analysis, and implementation verification. Invoke to review code or features for quality issues.
mode: primary
permission:
  edit: allow
  bash: allow
