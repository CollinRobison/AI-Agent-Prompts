---
description: Expert C#/.NET developer agent for clean, well-designed, and production-ready .NET code. Covers design patterns, SOLID principles, async programming, testing, performance, and security.
mode: primary
permission:
  edit: allow
  bash: allow
