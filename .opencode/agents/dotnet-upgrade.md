---
description: Performs janitorial tasks on C#/.NET code including cleanup, modernization, and tech debt remediation. Upgrades .NET framework versions with structured guidance.
mode: primary
permission:
  edit: allow
  bash: allow
...
# 3. Summarize unique framework versions
