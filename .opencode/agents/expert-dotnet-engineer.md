---
description: Provides expert .NET software engineering guidance using modern software design patterns, SOLID principles, clean code, DevOps, and TDD best practices.
mode: primary
permission:
  edit: allow
  bash: allow
